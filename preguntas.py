...
def pregunta_02():
    ...
    # Divida los datos de entrenamiento y prueba. La semilla del generador de n鷐eros
...
def pregunta_03():
    ...
    pipeline = Pipeline(
        steps=[
            ...
            # Paso 2: Construya un selector de caracter铆sticas que seleccione las K
            # caracter铆sticas m谩s importantes. Utilice la funci贸n f_regression.
            (
                "selectKBest",
                SelectKBest(score_func = f_regression),
            ),
            # Paso 3: Construya un modelo de regresi贸n lineal.
            (
                "linearRegression",
                LinearRegression(),
            ),
...
def pregunta_04():
    ...
    # Retorne el error cuadr醫ico medio para entrenamiento y prueba
